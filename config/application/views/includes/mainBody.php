                        ...
                        <div class="container">
                            <div class="navbar-header page-scroll">
                                ...
                                <div class="navbar-brand">
                                    <a class="logo-black" href="index.html"><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="">
                                    </a>
                                    <a class="logo-white" href="index.html"><img src="<?php echo base_url(); ?>assets/images/logo-white.png" alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="filtr-container">
                        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="3, 2" data-sort="value">
                            <div class="portfolio-item">
                                <img src="<?php echo base_url(); ?>assets/images/portfolio/1.jpg" class="img-responsive" alt="portfolio">
                                <div class="portfolio-item-info">
                                    <div class="item-caption">
                                        <ul>
                                            <li>
                                                <a href="<?php echo base_url(); ?>assets/images/portfolio/1.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                            </li>
                                            <li>
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="2, 1" data-sort="value">
                            <div class="portfolio-item">
                                <img src="<?php echo base_url(); ?>assets/images/portfolio/2.jpg" class="img-responsive" alt="portfolio">
                                <div class="portfolio-item-info">
                                    <div class="item-caption">
                                        <ul>
                                            <li>
                                                <a href="<?php echo base_url(); ?>assets/images/portfolio/2.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                            </li>
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="3, 1" data-sort="value">
                            <div class="portfolio-item">
                                <img src="<?php echo base_url(); ?>assets/images/portfolio/3.jpg" class="img-responsive" alt="portfolio">
                                <div class="portfolio-item-info">
                                    <div class="item-caption">
                                        <ul>
                                            <li>
                                                <a href="<?php echo base_url(); ?>assets/images/portfolio/3.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                            </li>
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="1, 2" data-sort="value">
                            <div class="portfolio-item">
                                <img src="<?php echo base_url(); ?>assets/images/portfolio/4.jpg" class="img-responsive" alt="portfolio">
                                <div class="portfolio-item-info">
                                    <div class="item-caption">
                                        <ul>
                                            <li>
                                                <a href="<?php echo base_url(); ?>assets/images/portfolio/4.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                            </li>
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="3, 2" data-sort="value">
                            <div class="portfolio-item">
                                <img src="<?php echo base_url(); ?>assets/images/portfolio/5.jpg" class="img-responsive" alt="portfolio">
                                <div class="portfolio-item-info">
                                    <div class="item-caption">
                                        <ul>
                                            <li>
                                                <a href="<?php echo base_url(); ?>assets/images/portfolio/5.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                            </li>
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="3, 1" data-sort="value">
                            <div class="portfolio-item">
                                <img src="<?php echo base_url(); ?>assets/images/portfolio/6.jpg" class="img-responsive" alt="portfolio">
                                <div class="portfolio-item-info">
                                    <div class="item-caption">
                                        <ul>
                                            <li>
                                                <a href="<?php echo base_url(); ?>assets/images/portfolio/6.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                            </li>
                ...
                <div class="col-md-12">
                    <div class="testimonial-carousel" data-slick='{"slidesToShow": 2, "slidesToScroll": 1}'>
                        ...
                        <div class="testimonial-item">
                            <div class="testimonial-item-content">
                                <div class="testimonial-img">
                                    <img src="<?php echo base_url(); ?>assets/images/testimonial/3.jpg" alt="">
                                </div>
                                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                <h4>Nil Mardana</h4>
                                <span>CEO, Envato</span>
                ...
                <div class="col-md-12">
                    <div class="blog-carousel" data-slick='{"slidesToShow": 3, "slidesToScroll": 1}'> 
                        <div class="blog-slide">                            
                            ...
                            <div class="blog-content">
                                <span class="blog-author">
                                    <a href="#"><img src="<?php echo base_url(); ?>assets/images/blog/post-1.jpg" alt=""></a>
                                </span>
                        ...
                        <div class="blog-slide">
                            ...
                            <div class="blog-content">
                                <span class="blog-author">
                                    <a href="#"><img src="<?php echo base_url(); ?>assets/images/blog/post-2.jpg" alt=""></a>
                                </span>
                                <h3><a href="blog-details.html">Here is the Post title</a></h3>
                                <p class="blog-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected.</p>
                            </div>
                        ...
                        <div class="blog-slide">
                            ...
                            <div class="blog-content">
                                <span class="blog-author">
                                    <a href="#"><img src="<?php echo base_url(); ?>assets/images/blog/post-3.jpg" alt=""></a>
                                </span>
                                <h3><a href="blog-details.html">Here is the Post title</a></h3>
                                <p class="blog-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected.</p>
                            </div>
                        ...
                        <div class="blog-slide">
                            ...
                            <div class="blog-content">
                                <span class="blog-author">
                                    <a href="#"><img src="<?php echo base_url(); ?>assets/images/blog/post-4.jpg" alt=""></a>
                                </span>
                                <h3><a href="blog-details.html">Here is the Post title</a></h3>
                                <p class="blog-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected.</p>
                            </div>
                        ...
                        <div class="blog-slide">
                            <div class="blog-img">
                                <img src="<?php echo base_url(); ?>assets/images/blog/5.jpg" alt="">
                                <a href="blog-details.html" class="read">read more</a>
                            </div>
                            <div class="blog-content">
                                <span class="blog-author">
                                    <a href="#"><img src="<?php echo base_url(); ?>assets/images/blog/post-5.jpg" alt=""></a>
                                </span>
                                <h3><a href="blog-details.html">Here is the Post title</a></h3>
                                <p class="blog-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected.</p>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="col-default">
                        <div class="row">
                            ...
                            <form id="ajax-contact" method="post" action="https://rajibweb.com/html/collis/php/contact.php">
                                <div class="col-md-6">
